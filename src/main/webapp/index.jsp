...
<div class="head">
    <div>
        ...
        <nav>
            <div class="logo">o'clock<span class="smile">&#9787;</span></div>
            ...
            <%
                if (isLoggedIn) {
            %>
                <input type="checkbox" id="userLoggedIn">  
            ...
            %>
            <!-- Add the user icon next to the login/logout button -->
            <div class="user-icon">
                <a href="<%= contextPath + StringUtils.PAGE_URL_USER_PROFILE %>"><i class="far fa-user"></i></a>
            </div>
            ...
            <input type="checkbox" id="form">
            <ul>
                <li> <label for="check-10" class="mobile-view">Home</label><a href="#">Home</i></a></li>
                <li><label for="check-9" class="mobile-view">Movies</label><a href="#">About Us</a></li>
                <li><input type="checkbox" id="check-4"><label for="check-4" class="mobile-view"> <i class="fas fa-caret-down"></i></label><a href="#">Product Categories <i class="fas fa-caret-down"></i></a>
                    <ul class="submenu-list">
                        <li class="submenu-heading"><a href=""><h1>Watch Categories <i class="fas fa-clock"></i></h1></a></li>
                        <li class="submenu-block">
                            <ul class="submenu-block__content">
                                <li class="submenu-list__item">
                                    <input type="checkbox" id="check-3"><label for="check-3" class="mobile-view"><span style="margin-left: -10px;">Brands</span><i class="fas fa-chevron-right"></i></label><a href="#">Brands</a>
                                ...
                                <li class="submenu-list__item">
                                    <input type="checkbox" id="check-2"><label for="check-2" class="mobile-view"><span style="margin-left: -10px;">Types</span><i class="fas fa-chevron-right"></i></label><a href="#">Types</a>
                                    <ul class="submenu-list__drop">
                                ...
                                <li class="submenu-list__item">
                                    <input type="checkbox" id="check-1"><label for="check-1" class="mobile-view"><span style="margin-left: -10px;">Countries</span> <i class="fas fa-chevron-right"></i></label><a href="#">Target Groups</a>
                                    <ul class="submenu-list__drop">
        ...
        <div class="cover__page">
          ...
          <!--    <img src="resources/images/products/gallery2.jpeg" alt="Your Image"> -->
                ...
                <br>
                <a href="<%= contextPath%>/UserProductServlet">Visit Now</a>
            </section>
        </div>
    </div>
    <footer class="footer">
